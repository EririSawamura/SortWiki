...
<head>
    ...
    <title>Introduction of insertion sort</title>
    ...
    <script>
        ...
        function SortAnimation() {
            document.getElementById("sort_animation").src="{{asset('/img/insertion-sort.gif')}}"
        }
    </script>
...
<section class="content-section bg-light" id="introduction">
    <div align="center" style="width: 960px; margin: auto" >
        <h2>Introduction of Insertion sort</h2>
        <p id="desc4" align="center" style="width: 750px; font-size: 20px">
            "In computer science, Insertion sort is a simple sorting algorithm that builds the
            final sorted array (or list) one item at a time. It is much less efficient on large
            lists than more advanced algorithms such as quicksort, heapsort, or merge sort."</p>
        <iframe align="center" width="960" height="720" style="margin: auto"
                src="http://www.youtube.com/embed/OGzPmgsI-pQ" frameborder="0" allowfullscreen>
...
<section class="content-section bg-light" id="animation">
    <div align="center">
        ...
        <p id="desc5" style="width: 700px; font-size: 20px">Initially, There are many strings which are arranged without
            order. When you click the 'Insertion sort' button, one of the strings will swap with each other
...
<section class="content-section bg-light" id="sort_example">
    <div align="center">
        <h2 id="sorting_example">Code example of Insertion sort</h2>
        ...
        of items remaining to be sorted that occupy the rest of the list. <br>
        1. Initially, the sorted sublist is empty and the unsorted sublist is the entire input list. <br>
        2. The algorithm proceeds by finding the smallest (or largest, depending on sorting order)
        element in the unsorted sublist. <br>
        3. Exchange (swapping) the smallest element with the leftmost unsorted element (putting it in
        sorted order), and moving the sublist boundaries one element to the right.<br></p>
        <pre><code id="hljs-http1">
