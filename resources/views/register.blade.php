...
<head>
    ...
    <script>
        function validate() {
            ...
            let conf_password = document.getElementById("conf_pwd").value;
            if (password !== conf_password){
                alert("Password and the confirmed password are not the same!");
                return false;
            }
            return true;
        }
...
<body>
    ...
    <div style="align-content: center; width: 640px; height: 480px; padding-top: 100px; margin: auto">
        <h4 class="display-2" style="margin: auto; text-align: center; padding-bottom: 40px" >Registration</h4>
        <form class="px-4 py-3" action="{{url('profile/register')}}" method="post" style="padding-top: 100px">
            {{csrf_field()}}
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="conf_pwd" id="conf_pwd" placeholder="Confirm your password"  required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" >
                ...
                <input type="button" class="btn btn-primary" value="Come back" onclick="window.location='{{url('/')}}';" />
            </div>
        </form>
    </div>
</body>
